...
function crux_single_product_page_navigation(){
	...
	<nav class="paging-navigation--wrapper single-product-navigation navigation">
		<?php previous_post_link( '<div class="nav-previous">%link</div>', '<span class="stag-icon icon-angle-left"></span>' ); ?>
		<?php next_post_link( '<div class="nav-next">%link</div>', '<span class="stag-icon icon-angle-right"></span>' ); ?>
