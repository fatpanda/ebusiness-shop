...
function stag_theme_setup(){
	...
	add_image_size( 'shop_single', 470, 577 );
}
endif;
...
function stag_scripts_styles(){
	...
	wp_enqueue_style( 'stag-custom-style', get_template_directory_uri() . '/assets/css/stag-custom-styles.php', $dependencies, STAG_THEME_VERSION );

	if ( ! wp_style_is( 'font-awesome', 'enqueued' ) ) {
		wp_enqueue_style( 'font-awesome', get_template_directory_uri()  . '/assets/css/font-awesome.css' , '', '4.0.3', 'all' );
	}
