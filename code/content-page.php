...
<article id="post-<?php the_ID(); ?>" <?php post_class(); stag_markup_helper( array( 'context' => 'entry' ) ); ?>>
	...
	<?php else : ?>
		<?php $page_class = ( stag_is_woocommerce_page() ) ? 'section-header' : 'entry-title'; ?>
		<h1 class="<?php echo $page_class; ?>"<?php stag_markup_helper( array( 'context' => 'title' ) ); ?>><?php the_title(); ?></h1>
	<?php endif; ?>
